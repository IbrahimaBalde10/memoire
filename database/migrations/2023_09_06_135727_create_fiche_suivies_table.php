...
return new class extends Migration
{
    ...
    {
        Schema::create('fiche_suivies', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('fichiepdf')->nullable(); // Colonne pour le nom du fichier PDF
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('fiche_suivies');
    }
};
